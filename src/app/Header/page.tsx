        ...
        <div className="flex justify-center px-4">
            <div className="flex my-4 h-[44px] gap-20 flex-wrap items-center">
                <div className="flex justify-between items-center w-full md:w-auto gap-20">
                    <div className="font-[Josefin Sans] font-bold text-4xl text-[#0D0E43] cursor-pointer">Hekto</div>
                    <ul className="flex gap-4 font-[Lato] font-medium flex-wrap">
                        <li className="flex my-auto h-[20px] gap-1 text-[#FB2E86] cursor-pointer">Home <i className="fa-solid fa-caret-down my-auto py-1 cursor-pointer"></i></li>
                ...
                <div className="flex mt-2 md:mt-0 cursor-pointer">
                    <input className="border-[2px] border-[#E7E6EF] w-[317px]" />
