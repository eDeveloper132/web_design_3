...
<main className="w-full bg-white">
    ...
    <div className="flex justify-center my-32">
        <h1 className="font-[Josefin Sans] text-[42px] leading-[49.22px] font-bold text-[#151875]">What Shopex Offer!</h1>
    </div>
    ...
    <div className="flex justify-center my-32">
        <h1 className="font-[Josefin Sans] text-[42px] leading-[50px] font-bold text-[#1A0B5B]">Trending Products</h1>
    </div>
    ...
    <div className="flex justify-center my-32">
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 gap-5">
            <div className="w-[420px] h-[270px] shadow-lg shadow-[#31208A0D]/5 bg-[#FFF6FB] flex flex-col">
            ...
            <div className="w-[420px] h-[270px] shadow-lg shadow-[#31208A]/5 bg-[#EEEFFB] flex flex-col">
            <div className="flex flex-col gap-2 ml-6 mt-6">
                    <h3 className="font-[Josefin Sans] font-bold text-[26px] leading-[26px] text-[#151875]">23% off in all products</h3>
            ...
            <div className="flex flex-col gap-6">
                <div className="w-[267px] h-[74px] flex gap-2">
                    <div className="w-[107px] h-[74px] bg-[#F5F6F8] flex justify-center">
                        <Image src={kursi_15} width={67} alt="kursi"></Image>
                    </div>
                    <div className="flex flex-col gap-1 justify-center">
                        <p className="font-[Josefin Sans] font-normal text-[16px] leading-[18.75px] text-[#151875]">
                            Executive Seat chair
                        </p>
                        <p className="font-[Josefin Sans] font-normal text-[12px] leading-[12px] text-[#151875] line-through">
                            $32.00
                        </p>
                    </div>
                </div>
    ...
    <div className="flex justify-center mt-32">
        <h1 className="font-[Josefin Sans] text-[42px] leading-[50px] font-bold text-[#1A0B5B]">Discounted Item</h1>
    </div>
    <div className="flex justify-center my-5 px-5">
    <ul className="flex flex-wrap gap-5 sm:gap-10 lg:gap-[58px] justify-center">
        <li className="text-[#FB2E86] font-[Lato] font-normal text-[16px] sm:text-[18px] leading-[21.6px] flex gap-2 sm:gap-3 items-center">
            <p className="border-b-2 border-[#FB2E86]">Wood Chair</p>
            <span className="w-[5px] h-[5px] bg-[#FB4997] rounded-full"></span>
        </li>
        <li className="text-[#151875] font-[Lato] font-normal text-[16px] sm:text-[18px] leading-[21.6px]">
            Plastic Chair
        </li>
        <li className="text-[#151875] font-[Lato] font-normal text-[16px] sm:text-[18px] leading-[21.6px]">
            Sofa Collection
